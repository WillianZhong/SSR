...
import com.study.shiro.KickoutSessionControlFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        list.forEach(sys->filterChainDefinitionMap.put(sys.getUrl(),
                sys.getPermissionInit()));
        ...
        log.info("Shiro filter register SUCCESS");
